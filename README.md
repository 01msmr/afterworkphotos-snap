...
- `index.html` — the page at snap.afterworkphotos.com; `img/app-awp20.jpg` is a staged screenshot — a real device shot, the print and LCD pasted in pixel-aligned
